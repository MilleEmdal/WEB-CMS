...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues" ConnectionString="<%$ ConnectionStrings:CMSConnectionString3 %>" DeleteCommand="DELETE FROM [Company] WHERE [CompanyID] = @original_CompanyID AND [Name] = @original_Name AND [Logo] = @original_Logo" InsertCommand="INSERT INTO [Company] ([Name], [Logo]) VALUES (@Name, @Logo)" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [Company]" UpdateCommand="UPDATE [Company] SET [Name] = @Name, [Logo] = @Logo WHERE [CompanyID] = @original_CompanyID AND [Name] = @original_Name AND [Logo] = @original_Logo">
                <DeleteParameters>
